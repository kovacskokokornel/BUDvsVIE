...
### Departure data
response = requests.get('https://www.viennaairport.com/jart/prj3/va/data/flights/out.json', headers=headers)
...
### Arrival data
response = requests.get('https://www.viennaairport.com/jart/prj3/va/data/flights/inc.json', headers=headers)
df = pd.DataFrame(response.json()["monitor"]["departure"])
...
print("Airborne: ", len(df_dep))
print("Arrival: ", len(df_arr))
